  ...
  try {
    ...
    $('div.last_episodes > ul > li').each((i, el) => {
      list.push({
        ...
        otherNames = $(el).find('p.othername').text().replace('Other names:', '').trim();
        const englishName = getEnglishName(otherNames); // Extract English name
      });
    });
...
// Helper function to extract English name from the "othernames" section
const getEnglishName = (otherNames) => {
  // Modify this function based on how English names are formatted in your "othernames" section
  // This is just a placeholder, you may need to customize it based on your specific case
  return otherNames; // Placeholder, replace with your logic
};
